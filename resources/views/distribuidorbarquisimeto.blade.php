            ...
            <div class="content">
                <div class="title m-b-md">    
                  <a href="/">
                    ...
                    <img src="/img/loguito.jpeg"style="
                    width: 100px;
                    height: 100px;"></a><p class="titulo">Distribuidor<br>Barquisimeto</p>
                  
                </div>
                <br>
                <br>
                 <img src="/img/promo.png" class="responsive">
                  >
                  <br>
                ...
                <box>
                  <body> <br>
                    <h2 style="font-family: 'Nunito', sans-serif, bold; height:80px;align-content: center;font-size: 20px; ">Sigue nuestras redes: </h2>
                    <div class="links">
                       <a href="https://twitter.com/MayoristaBqto_" style="padding-left: 20px"> 
